      ...
      <div className="home-container">
        ...
        <div className="home-main-content">
          <div className="home-image-wrapper">
            <img src="/webimagen.jpg" alt="Hero Banner" className="home-hero-image" />
          </div>
          ...
          <div className="home-content">
            ...
            <div className="home-links">
              <a href="https://www.linkedin.com/in/paolo-solis" target="_blank" rel="noopener noreferrer" className="home-link">
                <FaLinkedin size={20} style={{ marginRight: "8px" }} />
                LinkedIn
              </a>
              <a href="https://github.com/paolosolis" target="_blank" rel="noopener noreferrer" className="home-link">
